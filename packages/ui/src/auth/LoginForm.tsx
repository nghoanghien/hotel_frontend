...
export default function LoginForm({ onForgotPassword, onSuccess, onRegister, form, isLoading: externalLoading, error }: Props) {
    ...
    <div className="w-full h-full flex flex-col justify-center p-8 md:p-12 lg:p-16">
      <div className="flex justify-center mb-8">
        <div className="relative w-12 h-12 transform rotate-45 rounded-xl flex items-center justify-center hover:rotate-90 transition-all duration-500">
          ...
          <Hotel className="absolute inset-0 m-auto transform -rotate-45" size={24} strokeWidth={2.5} color="var(--primary)" />
        </div>
      </div>

      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Chào mừng đến với Hotelzy!</h1>
        <p className="text-gray-500 text-sm">Đặt phòng dễ dàng, trải nghiệm đẳng cấp</p>
      </div>
