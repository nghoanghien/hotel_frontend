...
const adminMenuItems = [
  ...
  { id: 'hotels', icon: Building2, text: 'Quản lý mạng lưới khách sạn', title: 'HOTEL NETWORK' },
  { id: 'staff', icon: Users, text: 'Quản trị nhân sự cao cấp', title: 'SENIOR STAFF' },
  { id: 'promotions', icon: Percent, text: 'Quản lý khuyến mãi', title: 'PROMOTIONS' }
];
